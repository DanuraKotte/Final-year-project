    ...
    <>
      ...
      <div className="container">
        <div className="row bg-light rounded my-5">
          <div className="col-12 text-center px-2 py-5">
            <h4>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda
              impedit magnam ipsum.
            </h4>
          </div>
        </div>
        <div className="row gap-2 justify-content-between my-5">
          <div
            ...
            <button className="btn-1 text-uppercase fs-4 my-5">try now</button>
          </div>
          <div
            ...
            <button className="btn-1 text-uppercase fs-4 my-5">buy now</button>
          </div>
          <div
